...
**Expected servers for this project:**
...
For example, for this wine inventory app, you should perform a test that:
- Logs into the app
- Navigates to the wine list
- Creates a wine entry
...
- [ ] Feature respects user role permissions (admin vs user)
...
- [ ] Created unique test data via UI (e.g., "测试红酒_12345_VERIFY")
...
1. Create NEW data with UNIQUE content (e.g., "测试_12345_DELETE_ME")
...
- Current completion status (e.g., "45/280 tests passing")
...
1. Trigger the email action (e.g., click "忘记密码")
...
**Design Requirements (from app_spec.txt):**

- Primary Color: #722F37 (Burgundy - 勃艮第红)
- Secondary Color: #C9A227 (Gold - 香槟金)
- Accent Color: #1E4D2B (Forest Green - 酒瓶绿)
